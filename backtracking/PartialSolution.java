...
public class PartialSolution{
    ...
    */
    ...
    /**
	Yields all extension of this partial solution
    ...
    */
	...
	PartialSolution[] p = new PartialSolution[NQUEENS];
	...
	for(int i = 0; i < NQUEENS; i++){
	    ...
	    p[i] = new PartialSolution(size + 1); 

	    //copu this solution into the new one
	    for(int j = 0; j < size; j++){
		p[i].queens[j] = queens[j];
	    }

	    //Append the new queen into the ith column
	    p[i].queens[size] = new Queen(size, i);
	}
